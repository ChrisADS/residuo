...
# Configurar el puerto serial (ajusta el nombre del puerto según tu sistema)
arduino = serial.Serial('COM3', 9600)  # Cambia 'COM3' por el puerto correcto en tu sistema
...
def enviar_dato(tipo_basura):
    if tipo_basura == "Metal":
        arduino.write(b'M')
    elif tipo_basura == "Glass":
        arduino.write(b'G')
    elif tipo_basura == "Plastic":
        arduino.write(b'P')
    elif tipo_basura == "Carton":
        arduino.write(b'C')
    elif tipo_basura == "Medical":
        arduino.write(b'B')
